...
/**
* @see \App\Http\Controllers\Admin\EmailTemplateController::preview
* @see app/Http/Controllers/Admin/EmailTemplateController.php:123
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
export const preview = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
preview.definition = {
    methods: ["get","head"],
    url: '/api/admin/email-templates/{emailTemplate}/preview',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
preview.url = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { emailTemplate: args }
    }

    if (typeof args === 'object' && !Array.isArray(args) && 'id' in args) {
        args = { emailTemplate: args.id }
    }
...
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
preview.get = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: preview.url(args, options),
    method: 'get',
})
...
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
preview.head = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: preview.url(args, options),
    method: 'head',
})
...
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
const previewForm = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
previewForm.get = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: preview.url(args, options),
    method: 'get',
})
...
* @route '/api/admin/email-templates/{emailTemplate}/preview'
*/
previewForm.head = (args: { emailTemplate: number | { id: number } } | [emailTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const EmailTemplateController = { index, store, show, update, destroy, preview }
